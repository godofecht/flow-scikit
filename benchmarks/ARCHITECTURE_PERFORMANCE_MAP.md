...
|---|---|---|---|---|---:|---:|
| `LogisticRegression` | `LogisticRegression` | iris | mixed | approximately equivalent | 10.42× | 76.6% |
| `LinearSVC` | `LinearSVC` | iris | external-native-bound | approximately equivalent | 5.70× |  |
| `KernelSVC_RBF` | `SVC` | iris | external-native-bound | approximately equivalent | 2.14× | 89.1% |
...
| `GaussianNB` | `GaussianNB` | iris | python-bound | parity verified | 48.15× | 78.2% |
| `KMeans` | `KMeans` | iris | mixed | approximately equivalent | 11.31× | 83.3% |
| `PCA` | `PCA` | iris | python-bound | parity verified | 16.68× | 76.2% |
| `LogisticRegression` | `LogisticRegression` | digits | mixed | approximately equivalent | 3.18× | 76.6% |
| `LinearSVC` | `LinearSVC` | digits | external-native-bound | approximately equivalent | 4.31× |  |
| `KernelSVC_RBF` | `SVC` | digits | external-native-bound | approximately equivalent | 3.20× | 89.1% |
...
| `GaussianNB` | `GaussianNB` | digits | python-bound | parity verified | 4.52× | 78.2% |
| `KMeans` | `KMeans` | digits | mixed | approximately equivalent | 1.41× | 83.3% |
| `Ridge` | `Ridge` | diabetes | python-bound | approximately equivalent | 12.55× |  |
| `Lasso` | `Lasso` | diabetes | mixed | approximately equivalent | 2.69× |  |
| `LinearRegression` | `LinearRegression` | diabetes | mixed | parity verified | 10.32× | 75.3% |
