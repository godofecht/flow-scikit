...
|---|---|---|---|---|---:|---:|
| `LogisticRegression` | `LogisticRegression` | iris | mixed | approximately equivalent | 10.16× | 76.4% |
| `LinearSVC` | `LinearSVC` | iris | external-native-bound | approximately equivalent | 0.63× |  |
| `KernelSVC_RBF` | `SVC` | iris | external-native-bound | approximately equivalent | 0.14× | 86.7% |
...
| `KMeans` | `KMeans` | iris | mixed | approximately equivalent | 4.28× | 84.2% |
| `PCA` | `PCA` | iris | python-bound | parity verified | 4.84× | 76.4% |
| `LogisticRegression` | `LogisticRegression` | digits | mixed | approximately equivalent | 2.30× | 76.4% |
| `LinearSVC` | `LinearSVC` | digits | external-native-bound | approximately equivalent | 0.22× |  |
| `KernelSVC_RBF` | `SVC` | digits | external-native-bound | approximately equivalent | 0.06× | 86.7% |
...
| `LinearRegression` | `LinearRegression` | diabetes | mixed | parity verified | 2.59× | 75.8% |
