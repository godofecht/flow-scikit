...
|---|---|---|---|---|---:|---:|
| `LogisticRegression` | `LogisticRegression` | iris | mixed | approximately equivalent | 14.02× | 76.5% |
| `LinearSVC` | `LinearSVC` | iris | external-native-bound | approximately equivalent | 0.70× |  |
| `KernelSVC_RBF` | `SVC` | iris | external-native-bound | approximately equivalent | 0.16× | 89.3% |
...
| `GaussianNB` | `GaussianNB` | iris | python-bound | parity verified | 22.55× | 77.6% |
| `KMeans` | `KMeans` | iris | mixed | approximately equivalent | 4.97× | 83.6% |
| `PCA` | `PCA` | iris | python-bound | parity verified | 5.34× | 77.4% |
| `LogisticRegression` | `LogisticRegression` | digits | mixed | approximately equivalent | 2.57× | 76.5% |
| `LinearSVC` | `LinearSVC` | digits | external-native-bound | approximately equivalent | 0.22× |  |
| `KernelSVC_RBF` | `SVC` | digits | external-native-bound | approximately equivalent | 0.07× | 89.3% |
...
| `GaussianNB` | `GaussianNB` | digits | python-bound | parity verified | 0.23× | 77.6% |
| `KMeans` | `KMeans` | digits | mixed | approximately equivalent | 0.04× | 83.6% |
| `Ridge` | `Ridge` | diabetes | python-bound | approximately equivalent | 2.85× |  |
| `Lasso` | `Lasso` | diabetes | mixed | approximately equivalent | 0.02× |  |
| `LinearRegression` | `LinearRegression` | diabetes | mixed | parity verified | 3.44× | 75.8% |
