...
| `KMeans` | `KMeans` | iris | mixed | approximately equivalent | 4.97× | 84.3% |
| `PCA` | `PCA` | iris | python-bound | parity verified | 5.34× | 77.8% |
...
| `KMeans` | `KMeans` | digits | mixed | approximately equivalent | 0.04× | 84.3% |
| `Ridge` | `Ridge` | diabetes | python-bound | approximately equivalent | 2.85× |  |
| `Lasso` | `Lasso` | diabetes | mixed | approximately equivalent | 0.02× |  |
| `LinearRegression` | `LinearRegression` | diabetes | mixed | parity verified | 3.44× | 75.9% |
