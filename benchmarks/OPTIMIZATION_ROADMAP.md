...
|---:|---|---|---|---:|---|---:|---|
| 1 | `GaussianNB` | `fit` | python-bound | 75.6 | rewrite first | 20.81× | remove Python control/validation and specialize the complete operation |
| 2 | `PCA` | `fit` | python-bound | 74.6 | rewrite first | 9.54× | remove Python control/validation and specialize the complete operation |
| 3 | `LogisticRegression` | `predict` | python-bound | 73.6 | rewrite first | 6.00× | remove Python control/validation and specialize the complete operation |
| 4 | `PCA` | `transform` | python-bound | 73.5 | rewrite first | 9.54× | remove Python control/validation and specialize the complete operation |
| 5 | `GaussianNB` | `predict` | python-bound | 73.4 | rewrite first | 20.81× | remove Python control/validation and specialize the complete operation |
| 6 | `LinearRegression` | `predict` | python-bound | 73.4 | rewrite first | 6.44× | remove Python control/validation and specialize the complete operation |
| 7 | `LogisticRegression` | `fit` | mixed | 72.0 | rewrite first | 6.00× | remove Python control/validation and specialize the complete operation |
| 8 | `KMeans` | `fit` | mixed | 71.9 | rewrite first | 3.18× | remove Python control/validation and specialize the complete operation |
| 9 | `LinearRegression` | `fit` | mixed | 68.6 | rewrite first | 6.44× | remove Python control/validation and specialize the complete operation |
| 10 | `KMeans` | `predict` | numpy-bound | 59.8 | rewrite first | 3.18× | remove Python control/validation and specialize the complete operation |
| 11 | `GaussianNB` | `predict_proba` | python-bound | 54.0 | rewrite first | 20.81× | remove Python control/validation and specialize the complete operation |
| 12 | `KMeans` | `transform` | python-bound | 54.0 | rewrite first | 3.18× | remove Python control/validation and specialize the complete operation |
| 13 | `LogisticRegression` | `predict_proba` | python-bound | 54.0 | rewrite first | 6.00× | remove Python control/validation and specialize the complete operation |
| 14 | `LogisticRegression` | `decision_function` | python-bound | 54.0 | rewrite first | 6.00× | remove Python control/validation and specialize the complete operation |
| 15 | `Ridge` | `fit` | python-bound | 54.0 | rewrite first | 5.88× | remove Python control/validation and specialize the complete operation |
| 16 | `Ridge` | `predict` | python-bound | 54.0 | rewrite first | 5.88× | remove Python control/validation and specialize the complete operation |
| 17 | `SVC` | `predict` | numpy-bound | 51.5 | rewrite first | 0.67× | remove Python control/validation and specialize the complete operation |
...
| 20 | `RandomForestClassifier` | `fit` | mixed | 48.0 | compile whole estimator | 4.79× | retain useful numerical kernels while fusing validation, allocation and orchestration |
| 21 | `RandomForestClassifier` | `predict` | mixed | 48.0 | compile whole estimator | 4.79× | retain useful numerical kernels while fusing validation, allocation and orchestration |
| 22 | `RandomForestClassifier` | `predict_proba` | mixed | 48.0 | compile whole estimator | 4.79× | retain useful numerical kernels while fusing validation, allocation and orchestration |
