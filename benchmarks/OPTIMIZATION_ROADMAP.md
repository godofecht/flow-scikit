...
| 2 | `PCA` | `fit` | python-bound | 74.1 | rewrite first | 4.84× | remove Python control/validation and specialize the complete operation |
| 3 | `GaussianNB` | `predict` | python-bound | 73.6 | rewrite first | 8.61× | remove Python control/validation and specialize the complete operation |
| 4 | `LogisticRegression` | `predict` | python-bound | 73.4 | rewrite first | 6.23× | remove Python control/validation and specialize the complete operation |
| 5 | `PCA` | `transform` | python-bound | 73.3 | rewrite first | 4.84× | remove Python control/validation and specialize the complete operation |
| 6 | `LogisticRegression` | `fit` | mixed | 71.8 | rewrite first | 6.23× | remove Python control/validation and specialize the complete operation |
| 7 | `LinearRegression` | `predict` | python-bound | 71.3 | rewrite first | 2.59× | remove Python control/validation and specialize the complete operation |
| 8 | `KMeans` | `fit` | mixed | 68.0 | rewrite first | 2.15× | remove Python control/validation and specialize the complete operation |
...
| 10 | `KMeans` | `predict` | numpy-bound | 56.0 | rewrite first | 2.15× | remove Python control/validation and specialize the complete operation |
...
| 15 | `SVC` | `predict` | numpy-bound | 49.4 | rewrite first | 0.10× | remove Python control/validation and specialize the complete operation |
