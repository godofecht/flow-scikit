...
|---:|---|---|---|---:|---|---:|---|
| 1 | `GaussianNB` | `fit` | python-bound | 75.4 | rewrite first | 26.62× | remove Python control/validation and specialize the complete operation |
| 2 | `PCA` | `fit` | python-bound | 74.1 | rewrite first | 5.50× | remove Python control/validation and specialize the complete operation |
| 3 | `LogisticRegression` | `predict` | python-bound | 73.7 | rewrite first | 7.94× | remove Python control/validation and specialize the complete operation |
| 4 | `PCA` | `transform` | python-bound | 73.5 | rewrite first | 5.50× | remove Python control/validation and specialize the complete operation |
| 5 | `LinearRegression` | `predict` | python-bound | 73.3 | rewrite first | 3.35× | remove Python control/validation and specialize the complete operation |
| 6 | `GaussianNB` | `predict` | python-bound | 73.2 | rewrite first | 26.62× | remove Python control/validation and specialize the complete operation |
| 7 | `LogisticRegression` | `fit` | mixed | 71.8 | rewrite first | 7.94× | remove Python control/validation and specialize the complete operation |
| 8 | `KMeans` | `fit` | mixed | 69.3 | rewrite first | 2.41× | remove Python control/validation and specialize the complete operation |
| 9 | `LinearRegression` | `fit` | mixed | 68.5 | rewrite first | 3.35× | remove Python control/validation and specialize the complete operation |
| 10 | `KMeans` | `predict` | numpy-bound | 56.8 | rewrite first | 2.41× | remove Python control/validation and specialize the complete operation |
| 11 | `GaussianNB` | `predict_proba` | python-bound | 54.0 | rewrite first | 26.62× | remove Python control/validation and specialize the complete operation |
| 12 | `LogisticRegression` | `predict_proba` | python-bound | 54.0 | rewrite first | 7.94× | remove Python control/validation and specialize the complete operation |
| 13 | `LogisticRegression` | `decision_function` | python-bound | 54.0 | rewrite first | 7.94× | remove Python control/validation and specialize the complete operation |
| 14 | `Ridge` | `fit` | python-bound | 53.6 | rewrite first | 2.92× | remove Python control/validation and specialize the complete operation |
| 15 | `Ridge` | `predict` | python-bound | 53.6 | rewrite first | 2.92× | remove Python control/validation and specialize the complete operation |
| 16 | `KMeans` | `transform` | python-bound | 51.1 | rewrite first | 2.41× | remove Python control/validation and specialize the complete operation |
| 17 | `SVC` | `predict` | numpy-bound | 49.4 | rewrite first | 0.11× | remove Python control/validation and specialize the complete operation |
| 18 | `RandomForestClassifier` | `fit` | mixed | 48.0 | compile whole estimator | 4.82× | retain useful numerical kernels while fusing validation, allocation and orchestration |
| 19 | `RandomForestClassifier` | `predict` | mixed | 48.0 | compile whole estimator | 4.82× | retain useful numerical kernels while fusing validation, allocation and orchestration |
| 20 | `RandomForestClassifier` | `predict_proba` | mixed | 48.0 | compile whole estimator | 4.82× | retain useful numerical kernels while fusing validation, allocation and orchestration |
