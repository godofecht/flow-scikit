...
|---:|---|---|---|---:|---|---:|---|
| 1 | `GaussianNB` | `fit` | python-bound | 75.5 | rewrite first | 20.40× | remove Python control/validation and specialize the complete operation |
| 2 | `PCA` | `fit` | python-bound | 74.2 | rewrite first | 4.73× | remove Python control/validation and specialize the complete operation |
| 3 | `GaussianNB` | `predict` | python-bound | 73.6 | rewrite first | 20.40× | remove Python control/validation and specialize the complete operation |
| 4 | `LogisticRegression` | `predict` | python-bound | 73.6 | rewrite first | 6.47× | remove Python control/validation and specialize the complete operation |
| 5 | `PCA` | `transform` | python-bound | 73.3 | rewrite first | 4.73× | remove Python control/validation and specialize the complete operation |
| 6 | `LogisticRegression` | `fit` | mixed | 71.9 | rewrite first | 6.47× | remove Python control/validation and specialize the complete operation |
| 7 | `LinearRegression` | `predict` | python-bound | 71.2 | rewrite first | 2.56× | remove Python control/validation and specialize the complete operation |
| 8 | `KMeans` | `fit` | mixed | 67.7 | rewrite first | 2.13× | remove Python control/validation and specialize the complete operation |
| 9 | `LinearRegression` | `fit` | mixed | 66.3 | rewrite first | 2.56× | remove Python control/validation and specialize the complete operation |
| 10 | `KMeans` | `predict` | numpy-bound | 55.6 | rewrite first | 2.13× | remove Python control/validation and specialize the complete operation |
| 11 | `GaussianNB` | `predict_proba` | python-bound | 54.0 | rewrite first | 20.40× | remove Python control/validation and specialize the complete operation |
| 12 | `LogisticRegression` | `predict_proba` | python-bound | 54.0 | rewrite first | 6.47× | remove Python control/validation and specialize the complete operation |
| 13 | `LogisticRegression` | `decision_function` | python-bound | 54.0 | rewrite first | 6.47× | remove Python control/validation and specialize the complete operation |
| 14 | `KMeans` | `transform` | python-bound | 49.6 | rewrite first | 2.13× | remove Python control/validation and specialize the complete operation |
| 15 | `SVC` | `predict` | numpy-bound | 49.3 | rewrite first | 0.10× | remove Python control/validation and specialize the complete operation |
| 16 | `Ridge` | `fit` | python-bound | 49.2 | rewrite first | 2.04× | remove Python control/validation and specialize the complete operation |
| 17 | `Ridge` | `predict` | python-bound | 49.2 | rewrite first | 2.04× | remove Python control/validation and specialize the complete operation |
| 18 | `RandomForestClassifier` | `fit` | mixed | 48.0 | compile whole estimator | 4.61× | retain useful numerical kernels while fusing validation, allocation and orchestration |
| 19 | `RandomForestClassifier` | `predict` | mixed | 48.0 | compile whole estimator | 4.61× | retain useful numerical kernels while fusing validation, allocation and orchestration |
| 20 | `RandomForestClassifier` | `predict_proba` | mixed | 48.0 | compile whole estimator | 4.61× | retain useful numerical kernels while fusing validation, allocation and orchestration |
