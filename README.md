...
The current canonical v2 result is [`benchmarks/headline_result_v2.json`](benchmarks/headline_result_v2.json): **19 of 19 rows are parity-eligible and measurement-resolved**. In that committed run, **Flow wins 9 of 19 end-to-end fit + predict comparisons and scikit-learn wins 10 of 19**. There are no parity-unresolved or measurement-unresolved rows.
